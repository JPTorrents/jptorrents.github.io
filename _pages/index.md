...
<div class="academic-page">
  <header class="page-header">
    <h1>Vita contemplativa</h1>
    <div class="affiliations" aria-label="Affiliations">
      <p>Postdoctoral researcher, Desautels Faculty of Management, McGill University.</p>
      <p>Fellow, Centre de Recherche en Gestion (CNRS–i3), Institut Polytechnique de Paris.</p>
    </div>
  </header>
...
<p class="profile-links">
  ...
  <nav class="toc" aria-label="Vita contemplativa sections">
    ...
    <ol class="toc-pages">
      <li><a href="{{ '/' | relative_url }}" aria-current="page">Vita contemplativa</a></li>
      <li><a href="{{ '/vita-activa/' | relative_url }}">Vita activa</a></li>
    </ol>
  ...
  <div class="document-body">
    <section id="research-program" aria-labelledby="research-program-heading">
      <h2 id="research-program-heading">Research program</h2>
      <p>My research examines how organizations collectively inquire into uncertain and evolving realities. I study how evidence, expertise, algorithmic technologies, and institutions are mobilized to make complex situations intelligible and actionable.</p>
      <p>Drawing on organization theory, science and technology studies, and pragmatist approaches, I analyze inquiry as a practical and collective process through which organizations define problems, produce knowledge, distribute judgment, coordinate action, and learn from the consequences of intervention. This perspective allows me to study knowledge and action together, rather than treating them as separate organizational processes.</p>
    ...
    <section id="key-articles" aria-labelledby="key-articles-heading">
      ...
      {% for slug in key_slugs %}
        ...
        {% if pub %}
          ...
          {% endif %}
          <article class="key-item" id="key-article-{{ pub.slug }}">
            <h3>{{ pub.title }}</h3>
            <p class="meta">{{ pub.year }} · {{ pub.venue }}</p>
            <p>{{ pub.abstract }}</p>
            <p>{% assign target_prefix = link_target | slice: 0, 4 %}<a href="{% if target_prefix == 'http' %}{{ link_target }}{% else %}{{ link_target | relative_url }}{% endif %}">Article link</a> · <a href="{{ '/vita-activa/#article-' | append: pub.slug | relative_url }}">CV entry</a></p>
          </article>
        {% endif %}
      {% endfor %}
    </section>
    <section id="key-essays" aria-labelledby="key-essays-heading">
      <h2 id="key-essays-heading">Key essays</h2>
      <article class="key-item" id="essay-organizing-as-collective-inquiry">
        <h3>Organizing as Collective Inquiry</h3>
        <p class="meta">Forthcoming</p>
        <p>Sets out the conceptual architecture for treating organizations as collective processes of problem definition, evidence production, judgment, and intervention.</p>
      </article>
      <article class="key-item" id="essay-healthcare-as-an-inquiry-system">
        <h3>Healthcare as an Inquiry System</h3>
        <p class="meta">Forthcoming</p>
        <p>Develops healthcare as a setting where knowledge and action are recursively organized under uncertainty.</p>
      </article>
      <article class="key-item" id="essay-ai-in-expert-work">
        <h3>AI in Expert Work: From Replacement to Distributed Judgment</h3>
        <p class="meta">Forthcoming</p>
        <p>Reframes AI in expert work as a redistribution of inquiry and judgment rather than a substitution of human expertise.</p>
      </article>
      <article class="key-item" id="essay-hta-as-organized-inquiry">
        <h3>HTA as Organized Inquiry</h3>
        <p class="meta">Forthcoming</p>
        <p>Interprets health technology assessment as a practical organization of evidence, valuation, and accountable intervention.</p>
      </article>
      <article class="key-item" id="essay-organizations-of-cultivation">
        <h3>Organizations of Cultivation</h3>
        <p class="meta">Forthcoming</p>
        <p>Explores organizational forms oriented to formation, care, maintenance, and long-run development.</p>
      </article>
      <article class="key-item" id="essay-from-decision-support-to-inquiry-support">
        <h3>From Decision Support to Inquiry Support</h3>
        <p class="meta">Forthcoming</p>
        <p>Argues for designing AI systems that support the organization of inquiry, not only the moment of decision.</p>
      </article>
    </section>
  </div>
</div>
